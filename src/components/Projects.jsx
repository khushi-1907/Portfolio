...
},
{
  ...
  image: "/projects/netflix_clone.png" // Replace with your image path
},
{
  ...
  tags: ["HTML", "CSS", "JavaScript", "UI/UX"],
  image: "/projects/extension_manager_ui.png" // Replace with your actual image path
},
{
  ...
  image: "/projects/portfolio.png" // Replace with actual path to your preview image
}
...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      {/* 🪐 Header */}
      {/* 🪐 Heading & Filters with Scroll Animation */}
      <motion.div
      ...
      `}
            // Animate the active button with a subtle scale + glow pulse
            animate={
              activeFilter === filter
                ? {
                    scale: [1, 1.1, 1], // pop effect scale up then back
                    boxShadow: [
                      "0 0 0px rgba(128, 90, 213, 0)", // no glow at start
                      "0 0 8px rgba(128, 90, 213, 0.6)", // purple glow peak
                      "0 0 0px rgba(128, 90, 213, 0)", // glow fade out
                    ],
                  }
